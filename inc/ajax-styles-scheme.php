...
//add_action( 'wp_ajax_dsfr_reload_styles', 'wpdsfr__reload_styles' );
//add_action( 'wp_ajax_nopriv_dsfr_reload_styles', 'wpdsfr__reload_styles' );

function wpdsfr__update_with_dark_theme( $theme_json ) {
...
function wpdsfr__reload_styles() {

	if ( isset( $_GET['scheme'] ) && $_GET['scheme'] === 'dark' ) {
		add_filter( 'wp_theme_json_data_user', 'wpdsfr__update_with_dark_theme' );
	}
